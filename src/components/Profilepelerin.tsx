    ...
    return <>
        <div className="bg-primary info-pelerins" style={{ height: 'calc(100vh - 140px)', width: '67%' }}>
            ...
            <div className="profile-pelerin d-flex flex-column align-items-center  justify-content-center " style={{ height: 'calc(100vh - 200px', overflow: 'scroll' }}>
                ...
                <div className='bg-info card d-flex flex-column  justify-content-evenly ps-3' style={{ width: 500, height: 450 }}>
                    <h6 className="text-white">Lieu de naisance: {props.pelerin ? props.pelerin.lieuNaissance : undefined}</h6>
                    <h6 className="text-white">Date de naissance: {props.pelerin ? props.pelerin.dateNaissance : undefined}</h6>
                    <h6 className="text-white">Lieu de provenance: {props.pelerin ? props.pelerin.lieuPovenance : undefined}</h6>
                    <h6 className="text-white">Date d'enregistrement: {props.pelerin ? props.pelerin.dateEnregistrement : undefined}</h6>
                    <h6 className="text-white">Agence : {props.pelerin ? props.pelerin.agence : undefined}</h6>
                </div>
                {props.pelerin ? (props.pelerin.accepted ?
                    ...
                    <div className="valid-reject d-flex justify-content-around   align-items-center  mt-2" style={{ height: 60, width: 500 }}>
                        <div className="d-flex flex-column justify-content-center align-items-center">
                            <button onClick={() => props.pelerin ? props.handleValidate(props.pelerin?.id) : ''} className="d-flex btn btn-primary">Valider</button>
                        </div>
                        <div className="d-flex flex-column justify-content-center align-items-center">
                            <button onClick={() => { props.setAffichage('Listpelerins') }} className="d-flex btn btn-secondary">Annuler</button>
                        </div>
