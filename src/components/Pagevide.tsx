...
export const Pagevide = (): JSX.Element => {
    return <>
        <div className="profile-pelerin d-flex flex-column align-items-center " style={{ height: 'calc(100vh - 140px', overflow: 'scroll', width: '67%', backgroundColor: 'rgba(153, 175, 186, 0.37)' }}>
